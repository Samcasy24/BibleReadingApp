...
| Role | Permissions |
|------|-------------|
| **Admin** | Manage groups, assign plans, manage all users, view all data, send reminders |
...
- Optional: member adds a short plain-text reflection note (max 500 characters).
...
| # | Question | Decision |
|---|----------|----------|
| 1 | Reflection note format | Plain text only (max 500 chars) |
